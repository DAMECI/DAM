...
public class StubCalificacion implements OperacionCalificacion{
    ...
    {
        calificaciones.add(new Calificacion(1,5,"Buen servicio",new Usuario("Diego", "Becerra", "11111", "diego@gmail.com", "12345")));
        calificaciones.add(new Calificacion(2,4,"Buen servicio",new Usuario("Diego", "Becerra", "11111", "diego@gmail.com", "12345")));
    }
